...
class Studyprogramslistscreen extends StatelessWidget {


  const Studyprogramslistscreen({Key? key, })
      : super(key: key);
      ...
      body: SafeArea(
        child: StreamBuilder<QuerySnapshot>(
          stream: FirebaseFirestore.instance
              .collection('courses')
              .where('CourseName', ) // Filter by universityName
              .snapshots(),
          builder: (context, snapshot) {
            ...
            return ListView(
              ...
              children: snapshot.data!.docs.map((DocumentSnapshot document) {
                ...
                final universityName = courseData["university"];
                return Padding(
